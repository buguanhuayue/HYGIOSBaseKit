...
#import "HYGUIFactory.h"

@implementation HYGUIFactory
#pragma mark---UILabel
                     ...
                     dataSource:(id <UITableViewDataSource>)dataSource
{
    ...
    if([className isKindOfClass:[NSArray class]] && className.count > 0){
        for(NSString *classStr in className){
            if([classStr isKindOfClass:[NSString class]] && classStr != nil && NSClassFromString(classStr)){
